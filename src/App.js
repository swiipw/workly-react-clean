...
// --- Configuración de Tailwind (mantener para desarrollo) ---
window.tailwind.config = {
  theme: {
    extend: {
      colors: {
        'workly-primary': '#17202A', 'workly-secondary': '#1ABC9C', 'workly-accent': '#F39C12', 'workly-light-bg': '#85C1E9', 'workly-orange': '#E67E22' 
      },
