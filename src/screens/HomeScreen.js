...
const StatCard = ({ icon: Icon, title, value, color }) => (
    // CORRECCIÓN AQUÍ: className debe estar dentro de {} y usar backticks ``
    ...
    return (
        <div className="p-4 space-y-6">
            ...
            <header className="pt-2 pb-4 border-b border-gray-200">
                ...
                <h2 className="text-3xl font-extrabold text-[#17202A]">¡Hola, {user ? user.name : 'Usuario'}! 👋</h2>
